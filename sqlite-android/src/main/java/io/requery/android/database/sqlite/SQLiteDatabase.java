...
public final class SQLiteDatabase extends SQLiteClosable implements SupportSQLiteDatabase {
        ...
        return rawQueryWithFactory(new CursorFactory() {
            ...
            public SQLiteProgram newQuery(SQLiteDatabase db, String sql, Object[] selectionArgs, CancellationSignal cancellationSignal) {
                if (mCursorFactory == null) {
                    return new SQLiteQuery(db, sql, selectionArgs, cancellationSignal);
                } else {
                    return mCursorFactory.newQuery(db, sql, selectionArgs, cancellationSignal);
                }
            }
    ...
    public interface CursorFactory {
        SQLiteProgram newQuery(SQLiteDatabase db, String sql, Object[] selectionArgs, CancellationSignal cancellationSignal);
